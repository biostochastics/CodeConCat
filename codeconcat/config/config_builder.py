...
class ConfigBuilder:
    ...
    def _finalize_paths(self) -> None:
        ...
        if ("output" not in self._config_dict or not self._config_dict["output"]) and "format" in self._config_dict:
        ...
        if "use_default_excludes" in self._config_dict and self._config_dict["use_default_excludes"] is True:
            ...
            default_excludes = [pattern for pattern in DEFAULT_EXCLUDE_PATTERNS 
        ...
        if ("include_paths" not in self._config_dict or not self._config_dict["include_paths"]):
            ...
            if "source_url" in self._config_dict and self._config_dict["source_url"]:
                ...
                js_patterns = [
                    ...
                    "components/**/*.ts", "components/**/*.tsx", "components/**/*.js", "components/**/*.jsx",
    ...
    def print_config_details(self) -> None:
        ...
        source_groups: Dict[ConfigSource, List[str]] = {
...
def load_config(cli_args: Dict[str, Any], config_path_override: Optional[str] = None) -> CodeConCatConfig:
    """
