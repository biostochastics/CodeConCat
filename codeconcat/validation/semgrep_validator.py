...
class SemgrepValidator:
    ...
    def scan_file(self, file_path: Union[str, Path], language: Optional[str] = None) -> List[Dict]:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            cmd.extend([
                "--json",
                "--output", f"{temp_dir}/results.json",
                str(file_path)
            ])
    ...
    def scan_directory(self, directory: Union[str, Path], languages: Optional[List[str]] = None) -> Dict[str, List[Dict]]:
        """
