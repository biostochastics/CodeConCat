            ...
            for i, line in enumerate(lines):
                ...
                if in_multiline_comment:
                    if self.multi_line_comment_end_pattern.search(line):
                        ...
                        if not stripped_line: continue # Line was just the end of the comment
                    else:
                ...
                for match in self.import_pattern.finditer(original_line): # Use original line for regex accuracy
