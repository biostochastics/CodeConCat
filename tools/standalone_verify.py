        ...
        try:
            ...
            try:
                ...
                lang_module_path = os.path.join(
                    ...
                    f"tree_sitter_{language.lower()}.so" if not language in ["javascript", "typescript", "c", "cpp"] else 
                    "tree_sitter_javascript.so" if language in ["javascript", "typescript"] else
                    "tree_sitter_cpp.so"
                )
