...
'''
    ...
    def test_r_parser_parse(self, r_code_sample):
        ...
        if add_values_func is not None:
            ...
            if add_values_func.docstring and "A utility function with roxygen2 documentation" in add_values_func.docstring:
        ...
        if print_person_method is not None:
            ...
            if print_person_method.docstring and "Print method for person class" in print_person_method.docstring:
                print("S3 method docstring correctly detected")
        
        # Check for S4-related declarations
        s4_decls = [d for d in result.declarations if d.name and ("S4" in d.name or d.name.startswith("set"))]
