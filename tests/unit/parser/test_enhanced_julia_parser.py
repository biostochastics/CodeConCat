...
class TestEnhancedJuliaParser:
    ...
    def test_julia_parser_parse(self, julia_code):
        ...
        if module_decl:
            print(
                f"Found module: {module_decl.name} at lines {module_decl.start_line}-{module_decl.end_line}"
            )
        ...
        if struct_decl:
            print(
                f"Found struct: {struct_decl.name} at lines {struct_decl.start_line}-{struct_decl.end_line}"
            )
        ...
        if function_decl:
            print(
                f"Found function: {function_decl.name} at lines {function_decl.start_line}-{function_decl.end_line}"
            )
            ...
            if function_decl.children:
                print(
                    f"Found {len(function_decl.children)} nested functions inside {function_decl.name}"
                )
