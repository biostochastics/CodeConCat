...
'''
    ...
    def test_php_parser_parse(self, php_code_sample):
            ...
            try:
                ...
                if "file_path" in str(e):
                    ...
                    try:
                        ...
                        parser._process_block(lines, 0, len(lines) - 1, declarations, imports, errors)
        ...
        if person_class:
            ...
            if person_class.docstring and "simple class with documentation" in person_class.docstring:
        ...
        if calc_stats_func:
            print(f"Found calculateStats function at lines {calc_stats_func.start_line}-{calc_stats_func.end_line}")
