...
'''
    ...
    def test_csharp_parser_parse(self, csharp_code_sample):
        ...
        if namespace_decl:
            print(f"Found namespace {namespace_decl.name} at lines {namespace_decl.start_line}-{namespace_decl.end_line}")
        ...
        if constants_class:
            print(f"Found Constants class at lines {constants_class.start_line}-{constants_class.end_line}")
        ...
        if person_class:
            ...
            if person_class.children:
                ...
                if greet_method:
                    print(f"Found Greet method at lines {greet_method.start_line}-{greet_method.end_line}")
        ...
        if processor_interface:
            print(f"Found IProcessor interface at lines {processor_interface.start_line}-{processor_interface.end_line}")
            if processor_interface.docstring and "Interface for data processors" in processor_interface.docstring:
