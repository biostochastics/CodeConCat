...
from codeconcat.validation.security import SecurityValidator, security_validator
...
class TestSecurityValidator:
    ...
    def test_sanitize_content(self):
        ...
        patterns = {
            "sql_injection": re.compile(r"SELECT\s+\*\s+FROM\s+users", re.IGNORECASE)
        }
        ...
        assert sanitized == "/* POTENTIALLY DANGEROUS CONTENT REMOVED: SELECT * FROM users */ WHERE username = 'admin'"
