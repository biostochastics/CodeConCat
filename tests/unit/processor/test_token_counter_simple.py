...
"""
    ...
    def test_get_token_stats_with_mock_tiktoken(self, mock_encoding_for_model, mock_claude_tokenizer):
        ...
        assert mock_encoding_for_model.call_count >= 2  # GPT-3.5 and GPT-4
        assert stats.gpt3_tokens == 5
        assert stats.gpt4_tokens == 5
